      ...
      <section className="relative pt-16 sm:pt-24 pb-16 sm:pb-24 px-4 sm:px-6 overflow-hidden aura-bg-gradient aura-grid-pattern">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 mb-12 select-none">
            ...
            {/* 3: Citation & Literature Integrity Audit (Man reading paper) */}
            <button
              type="button"
          ...
          <div className="relative mx-auto max-w-5xl text-left">
            ...
            <div className="rounded-2xl sm:rounded-3xl border border-black/10 dark:border-white/10 liquid-glass-canvas shadow-[0_30px_90px_-15px_rgba(0,0,0,0.35),0_0_0_1px_rgba(255,255,255,0.4)] dark:shadow-[0_30px_90px_-15px_rgba(0,0,0,0.85),0_0_0_1px_rgba(255,255,255,0.08)] overflow-hidden">
              ...
              <div className="flex items-center justify-between px-4 py-2.5 border-b border-black/5 dark:border-white/10 liquid-glass-header select-none text-xs gap-3">
                ...
                {/* Right Top Bar Controls: Theme Toggle */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[580px]">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="pl-5 space-y-0.5 border-l border-black/5 dark:border-white/10 ml-3.5">
                        ...
                        >
                          ...
                          <span>Citation &amp; Evidence Audit</span>
                        </button>
                        <button
                          type="button"
                ...
                <div className="lg:col-span-8 xl:col-span-9 p-4 sm:p-6 lg:p-7 space-y-4 overflow-y-auto no-scrollbar max-h-[640px]">
                  ...
                  {/* Sub-view: Citation & Literature Integrity Audit (Man Reading Paper) */}
                  {activeTab === 'references' && (
                    <div className="space-y-3.5 animate-fade-in">
                      <div className="flex items-center justify-between pb-2 border-b border-black/5 dark:border-white/10">
                      ...
                      {/* Grounding Matrix Items */}
                      <div className="p-4 rounded-2xl liquid-glass-card space-y-2">
                        <h4 className="text-xs font-bold text-neutral-900 dark:text-white uppercase tracking-wider">
                          Audited Claim-Citation Pairs
                        </h4>
                        <div className="space-y-2 text-xs">
                          <div className="p-2.5 rounded-xl bg-black/5 dark:bg-white/5 flex items-start gap-2.5">
                            <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" />
                            <div className="space-y-0.5">
                              <span className="font-semibold text-neutral-900 dark:text-white">&ldquo;DLL3 surface expression in SCLC models&rdquo;</span>
                              <p className="text-[11px] text-neutral-500 dark:text-neutral-400">Verified &rarr; Saunders et al. Sci Transl Med 2015 (DOI: 10.1126/scitranslmed.aac9459)</p>
                            </div>
                          </div>
                          <div className="p-2.5 rounded-xl bg-black/5 dark:bg-white/5 flex items-start gap-2.5">
                            <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" />
                            <div className="space-y-0.5">
                              <span className="font-semibold text-neutral-900 dark:text-white">&ldquo;POU2F1 transcriptional network in neuroendocrine cells&rdquo;</span>
                              <p className="text-[11px] text-neutral-500 dark:text-neutral-400">Verified &rarr; Borromeo et al. Cell Rep 2016 (DOI: 10.1016/j.celrep.2016.06.071)</p>
                            </div>
                          </div>
                        </div>
                      </div>
